...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('registrars.update', $registrar->id) }}" method="post">
                @csrf
                @method('PUT')
                   ...
                   <div class="col-6">
                        <div class="form-group">
                            ...
                            <input 
                                ...
                                name="first_name"
                                value="{{ old('first_name', $registrar->first_name) }}"
                            >
                            @error('first_name')
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input 
                                ...
                                name="last_name"
                                value="{{ old('last_name', $registrar->last_name) }}"
                            >
                            @error('last_name')
                                <div class="invalid-feedback">
                                    {{ $message }}
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <input 
                                ...
                                name="birthed_at"
                                value="{{ old('birthed_at', \Carbon\Carbon::parse($registrar->birthed_at)->format('Y-d-m')) }}"
                            >
                            @error('birthed_at')
                                <div class="invalid-feedback">
                                    {{ $message }}
                        ...
                        <div class="form-group">
                            ...
                            >
                                ...
                                @foreach ($departments as $department)
                                    <option 
                                        {{ old('department_id', $registrar->department_id) == $department->id ? 'selected' : '' }}
                                        value="{{ $department->id }}"
                                    >
                                        {{ $department->name }}
                                    </option>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input 
                                                ...
                                                name="email"
                                                value="{{ old('email', $registrar->user->email) }}"
                                            >
                                            @error('email')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
